...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "/men",
        element: <Shopcategory bannerImg={banner_mens} category="men" />,
      },
      {
        path: "/kid",
        element: <Shopcategory bannerImg={banner_kids} category="kid" />,
      },
      {
        path: "/women",
        element: <Shopcategory bannerImg={banner_women} category="women" />,
      },
      {
